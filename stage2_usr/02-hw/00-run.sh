...
if [ $SHTDN ]; then
	param_on "# Shutdown button"
	param_on "dtoverlay=gpio-shutdown,gpio_pin=${SHTDN}"
fi

if [ $PWROFF ]; then
	param_on "# Poweroff output pulse (active_low=1 - negative pulse)"
	param_on "dtoverlay=gpio-poweroff,gpiopin=${PWROFF},active_low=1,inactive_delay_ms=4000,active_delay_ms=50"
fi
...
if [ $PWM ]; then
	...
	case $PWM in
		# dual channel
		"12,13") param_on "dtoverlay=pwm-2chan,pin=12,func=4,pin2=13,func2=4" ;;
		"18,13") param_on "dtoverlay=pwm-2chan,pin=18,func=2,pin2=13,func2=4" ;;
		"12,19") param_on "dtoverlay=pwm-2chan,pin=12,func=4,pin2=19,func2=2" ;;
		"18,19") param_on "dtoverlay=pwm-2chan,pin=18,func=2,pin2=19,func2=2" ;;
		# single channel
		"12") param_on "dtoverlay=pwm,pin=12,func=4" ;;
		"18") param_on "dtoverlay=pwm,pin=18,func=2" ;;
		"13") param_on "dtoverlay=pwm,pin=13,func=4" ;;
		"19") param_on "dtoverlay=pwm,pin=19,func=2" ;;
